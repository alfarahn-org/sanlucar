                ...
                <div className={styles.chatContainer}>
                    {!lastQuestionRef.current ? (
                        <div className={styles.chatEmptyState}>
                            <img src={logo} alt="Chat logo" style={{ maxWidth: "140px", height: "auto" }} />
                            <h2 className={styles.chatEmptyStateSubtitle}>Ask anything or try one of examples</h2>
                    ...
                    <div className={styles.chatInput}>
                        <QuestionInput
                            clearOnSend
                            placeholder="Type a new question related to your knowledge base"
                            disabled={isLoading}
